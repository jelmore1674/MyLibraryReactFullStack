...
var RegisterController = /** @class */ (function () {
    ...
    RegisterController.prototype.handleRegister = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, name, password, user, token, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, email = _a.email, name = _a.name, password = _a.password;
                        if (!(!email || !name || !password)) return [3 /*break*/, 1];
                        res.status(401).json('Missing credentials');
                        return [3 /*break*/, 6];
                    case 1:
                        _b.trys.push([1, 5, , 6]);
                        return [4 /*yield*/, models_1.UserModel.createUser(email, password, name)];
                    case 2:
                        user = _b.sent();
                    ...
                    case 3:
                        // Create Default library
                        _b.sent();
                        return [4 /*yield*/, auth_1.Auth.createSessions(user)];
                    case 4:
                        token = _b.sent();
                        // Return token
